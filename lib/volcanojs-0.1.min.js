...
function(a,b){this._checkRangeError(b);this.getElementIndex(a)!==b&&(this.removeElement(a),this.addElementAt(a,b))};a.setAlpha=function(a){this._alpha=a;this._domElement.style.opacity=a;return this};a.getAlpha=function(){return this._alpha};a._visible=false;a.setVisible=function(a){var b;this._visible=a;a===true?b="visible":b="hidden";this._domElement.style.visibility=b;return this};a.getVisible=function(){return this._visible};e.volcano.VolcanoSprite=b})(window);(function(e){var b=function(a){this.initialize(a)},a=b.prototype=new volcano.VolcanoSprite;a.VolcanoSprite_initialize=a.initialize;a.instance=null;a._nestLevel=0;a._body=null;a._onEnterFrameItems=null;a.initialize=function(a){this.instance={};this._body={};this._onEnterFrameItems=[];this.VolcanoSprite_initialize();Ticker.setFPS(this._fps);Ticker.addListener(this);this.setWidth(e.innerWidth).setHeight(e.innerHeight).setId("systemManager");a?this._body=a:this._body=document.body;this._body.appendChild(this._domElement);
this._domElement.style.overflow="hidden";this._nestLevel=1;volcano.LayoutManager.systemManager=this;var b=this.instance=this;e.addEventListener("resize",function(){b.setWidth(e.innerWidth).setHeight(e.innerHeight);b.dispatchEvent("resize")})};a.getNestLevel=function(){return this._nestLevel};a._fps=24;a.setFrameRate=function(a){this._fps=a;Ticker.setFPS(a);return this};a.getFrameRate=function(){return this._fps};a.VolcanoSprite__elementAdded=a._elementAdded;a._elementAdded=function(a,b,f){this.VolcanoSprite__elementAdded(a,
...
a.addEnterFrameListener(b._waitFrame);b._listenersAttached=true};e.volcano.LayoutManager=b})(window);(function(e){var b=function(){this.initialize()},a=b.prototype=new volcano.VolcanoSprite,i=function(a,b){this.method=a;this.args=b};b._callLaterDispatcherCount=0;b._catchCallLaterExceptions=false;a._methodQueue=null;a.systemManager=null;a._skin=null;a.states=null;a._deferredSetStyles=null;a._owner=null;a._domElement=null;a._skinCanvas=null;a._updateCompletePendingFlag=false;a._processedDescriptiors=false;a.VolcanoSprite_initialize=a.initialize;a.initialize=function(){this._methodQueue=[];this.systemManager=
volcano.LayoutManager.systemManager;this._skin={};this.states=[];this._deferredSetStyles={};this._owner={};this._domElement={};this._skinCanvas={};this.VolcanoSprite_initialize();var a=document.documentMode,a=/msie [\w.]+/.exec(navigator.userAgent.toLowerCase())&&(!a||a<=7),b=this._width,c=this._height,d=document.createElement("canvas");d.width=b;d.height=c;try{a&&(d=e.G_vmlCanvasManager.initElement(d))}catch(i){}this._skinCanvas=d;this._domElement.appendChild(this._skinCanvas)};a.getOwner=function(){return this._owner?
...
if(this._listeningForRender)this.systemManager.removeEnterFrameListener(this._callLaterDispatcher),this._listeningForRender=false;var a=this._methodQueue;this._methodQueue=[];var f=a.length;if(f>0)for(var c=0;c<f;c++){var d=a[c];d.method.apply(null,d.args)}b._callLaterDispatcherCount--};a.callLater=function(a,b){this._methodQueue.push(new i(a,b));if(!this._listeningForRender)this.systemManager.addEnterFrameListener(this._callLaterDispatcher),this._listeningForRender=true};a.VolcanoSprite__elementAdded=
a._elementAdded;a._elementAdded=function(a,b,c){this.VolcanoSprite__elementAdded(a,b,c);a.parentChanged(this);a.setNestLevel(this.getNestLevel()+1);a.getInitialized()||a.initComponent()};a.VolcanoSprite__elementRemoved=a._elementRemoved;a._elementRemoved=function(a,b,c){a.parentChanged(null);this.VolcanoSprite__elementRemoved(a,b,c)};a.getUpdateCompletePendingFlag=function(){return this._updateCompletePendingFlag};a.setUpdateCompletePendingFlag=function(a){this._updateCompletePendingFlag=a};a.parentChanged=
