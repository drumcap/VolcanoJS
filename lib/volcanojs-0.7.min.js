...
c._pausedTime+=f);c._lastTime=a;for(var b=c._pauseable,e=c._listeners.slice(),g=e?e.length:0,h=0;h<g;h++){var k=e[h];k==null||d&&b[h]||(k.tick?k.tick(f,d):k instanceof Function&&k(f,d))}for(c._tickTimes.unshift(c._getTime()-a);c._tickTimes.length>100;)c._tickTimes.pop();for(c._times.unshift(a);c._times.length>100;)c._times.pop()};var b=window.performance&&(performance.now||performance.mozNow||performance.msNow||performance.oNow||performance.webkitNow);c._getTime=function(){return b&&b.call(performance)||
(new Date).getTime()};createjs.Ticker=c})();var Stats=function(){function c(a,f,d){var b,c,e;for(c=0;c<30;c++)for(b=0;b<73;b++)e=(b+c*74)*4,a[e]=a[e+4],a[e+1]=a[e+5],a[e+2]=a[e+6];for(c=0;c<30;c++)e=(73+c*74)*4,c<f?(a[e]=m[d].bg.r,a[e+1]=m[d].bg.g,a[e+2]=m[d].bg.b):(a[e]=m[d].fg.r,a[e+1]=m[d].fg.g,a[e+2]=m[d].fg.b)}var b=0,a=2,f,d=0,j=(new Date).getTime(),e=j,g=j,h=0,k=1E3,G=0,n,p,l,Q,v,y=0,s=1E3,z=0,t,A,H,L,r=0,I=1E3,q=0,u,o,E,P,m={fps:{bg:{r:16,g:16,b:48},fg:{r:0,g:255,b:255}},ms:{bg:{r:16,g:48,b:16},fg:{r:0,g:255,b:0}},mem:{bg:{r:48,g:16,
...
u.appendChild(o);l=document.createElement("canvas");l.width=74;l.height=30;l.style.display="block";l.style.marginLeft="3px";u.appendChild(l);E=l.getContext("2d");E.fillStyle="#301010";E.fillRect(0,0,l.width,l.height);P=E.getImageData(0,0,l.width,l.height);return{domElement:f,update:function(){d++;j=(new Date).getTime();y=j-e;s=Math.min(s,y);z=Math.max(z,y);c(L.data,Math.min(30,30-y/200*30),"ms");A.innerHTML='<span style="font-weight:bold">'+y+" MS</span> ("+s+"-"+z+")";H.putImageData(L,0,0);e=j;if(j>
g+1E3){h=Math.round(d*1E3/(j-g));k=Math.min(k,h);G=Math.max(G,h);c(v.data,Math.min(30,30-h/100*30),"fps");p.innerHTML='<span style="font-weight:bold">'+h+" FPS</span> ("+k+"-"+G+")";Q.putImageData(v,0,0);if(a==3)r=webkitPerformance.memory.usedJSHeapSize*9.54E-7,I=Math.min(I,r),q=Math.max(q,r),c(P.data,Math.min(30,30-r/2),"mem"),o.innerHTML='<span style="font-weight:bold">'+Math.round(r)+" MEM</span> ("+Math.round(I)+"-"+Math.round(q)+")",E.putImageData(P,0,0);g=j;d=0}}}};(function(c){var b=c.volcano,a,f=c._;!f&&typeof require!=="undefined"&&(f=require("underscore"),require("backbone"));if(typeof Backbone!=="undefined"&&Backbone)c.volcano=a=Backbone,a.BackboneVersion=a.VERSION;else throw Error("volcanojs needs backbonejs library. \n you must include backbonejs before volcanojs");a.VERSION="0.1";a.noConflict=function(){c.volcano=b;return this};f=navigator.userAgent.toLocaleLowerCase();a.isMobile={android:f.match(/android/i)?true:false,blackberry:f.match(/blackberry/i)?
...
this._string=["translate3d(",0,"px,",0,"px,",0,"px) ","rotateX(",0,"deg) ","rotateY(",0,"deg) ","rotateZ(",0,"deg) ","scale3d(",1,", ",1,", ",1,") "];this._positions=[1,3,5,8,11,14,17,19,21];this._oz=this._oy=this._ox=0;this._domElement=a;this._domElement.volcanoObj=this};a.addEventListener=function(a,d){var c,e,g,h,k,G,n,p;if(!a&&!d)return this;a=a.split(b._eventSplitter);c=this._callbacks||(this._callbacks={});for(G=function(a){if(a){if(!n||p!=a.target)n=p=a.target;if(!n.volcanoObj){n=n.parentNode;
G.call(this,a);return}a.vCurrentTarget=this.volcanoObj;a.vTarget=n.volcanoObj}d(a)};e=a.shift();)g=(k=c[e])?k.tail:{},g.next=h={},g.callback=G,c[e]={tail:h,next:k?k.next:g},this._domElement.addEventListener(e,G);return this};a.removeEventListener=function(a,d){var c,e,g,h,k;if(e=this._callbacks){if(!a&&!d)return this;for(a=a.split(b._eventSplitter);c=a.shift();)if(g=e[c],delete e[c],g&&d)for(h=g.tail;(g=g.next)!==h;)k=g.callback,this._domElement.removeEventListener(c,k);return this}};a.dispatchEvent=
...
"TransformOrigin"]};a.transformString=function(a){for(var a=a.toLowerCase().split(" "),d=a.length,b=0,c=[],g=[0,0,0,0,0,0,0,0,0],h=0;b<d;b++)switch(a[b]){case "p":case "position":case "translate":h=c.push("translate3d(",this._string[this._positions[0]],"px,",this._string[this._positions[1]],"px,",this._string[this._positions[2]],"px) ");g[0]=h-6;g[1]=h-4;g[2]=h-2;break;case "rx":case "rotatex":case "rotationx":h=c.push("rotateX(",this._string[this._positions[3]],"deg) ");g[3]=h-2;break;case "ry":case "rotatey":case "rotationy":h=
c.push("rotateY(",this._string[this._positions[4]],"deg) ");g[4]=h-2;break;case "rz":case "rotatez":case "rotationz":h=c.push("rotateZ(",this._string[this._positions[5]],"deg) ");g[5]=h-2;break;case "s":case "scale":h=c.push("scale3d(",this._string[this._positions[6]],",",this._string[this._positions[7]],",",this._string[this._positions[8]],") "),g[6]=h-6,g[7]=h-4,g[8]=h-2}this._string=c;this._positions=g;this.isAutoUpdate&&this.updateTransform();return this};a.perspective=function(a){return arguments.length?
...
this._source=a;return this};b._errorImg="";c.DEFAULT_ERR_IMGAGE="";b.errorImg=function(a){return arguments.length?(this._errorImg=a,this):this._errorImg===""?c.DEFAULT_ERR_IMGAGE:this._errorImg};this.window.volcano.Image=c})(window);(function(){var c=function(a,b){this.initialize(a,b)},b=c.prototype=new volcano.VObject;b._domElement=null;b.VObject_initialize=b.initialize;b.initialize=function(a,b){var c=document.createElement("li"),j=document.createElement("img"),e=document.createElement("span"),g=document.createElement("div"),h=document.createElement("span"),k=document.createElement("span");c.appendChild(j);c.appendChild(e);c.appendChild(g);g.appendChild(h);g.appendChild(k);this.imgObj=new volcano.VObject(j);this.spanOnAirObj=
new volcano.VObject(e);this.divObj=new volcano.VObject(g);this.divBgSpanObj=new volcano.VObject(h);this.divTextSpanObj=new volcano.VObject(k);this.VObject_initialize(c,b);this.addClass("dramaitem");this.imgObj.addClass("poster");this.spanOnAirObj.addClass("chaton onair");this.divObj.addClass("desc");this.divBgSpanObj.addClass("bg");this.divTextSpanObj.addClass("text chat");this.imgObj.percentWidth(100);this.imgObj.percentHeight(100)};b._dataProvider={};b.dataProvider=function(a){return arguments.length?
(this._dataProvider=a,this.id(this._dataProvider.id),this.imageUrl(this._dataProvider.filepath),this.title(this._dataProvider.title),this.lastTalk(this._dataProvider.lastTalk),this.userCnt(this._dataProvider.userCnt),this.onair(this._dataProvider.onair),this.company(this._dataProvider.company),this.actors(this._dataProvider.actors),this.story(this._dataProvider.story),this.twitterQuery(this._dataProvider.twitterQuery),this):this._dataProvider};b._title="";b.title=function(a){return arguments.length?
(this._title=a,this):this._title};b._lastTalk={};b.lastTalk=function(a){return arguments.length?(this._lastTalk=a,this._lastTalk.user.trim()===""&&this._lastTalk.talk.trim()===""?(this.divTextSpanObj._domElement.innerHTML=this.title(),this.removeClassDivText("chat")):(this.divTextSpanObj._domElement.innerHTML="["+this._lastTalk.user+"] "+this._lastTalk.talk,this.addClassDivText("chat")),this):this._lastTalk};b._userCnt="";b.userCnt=function(a){return arguments.length?(this._userCnt=a,this.spanOnAirObj._domElement.innerHTML=
this._userCnt===""?0:parseInt(this._userCnt),this):this._userCnt};b.onair=function(a){(this._onair=a)?this.addClassOnAir("onair"):this.removeClassOnAir("onair")};b._company="";b.company=function(a){return arguments.length?(this._company=a,this):this._company};b._actors=[];b.actors=function(a){return arguments.length?(this._actors=name,this):this._actors};b._story="";b.story=function(a){return arguments.length?this:this._story};b._twitterQuery="";b.twitterQuery=function(a){return arguments.length?
this:this._twitterQuery};b.imageUrl=function(a){this.imgObj._domElement.src=a;return this};b.addClassImage=function(){for(var a=arguments,b=a.length,a=a[0],c=1;c<b;c++)a=a+", "+a;this.imgObj.addClass(a);return this};b.removeClassImage=function(){for(var a=arguments,b=a.length,a=a[0],c=1;c<b;c++)a=a+", "+a;this.imgObj.removeClass(a);return this};b.addClassOnAir=function(){for(var a=arguments,b=a.length,a=a[0],c=1;c<b;c++)a=a+", "+a;this.spanOnAirObj.addClass(a);return this};b.removeClassOnAir=function(){for(var a=
arguments,b=a.length,a=a[0],c=1;c<b;c++)a=a+", "+a;this.spanOnAirObj.removeClass(a);return this};b.addClassDiv=function(){for(var a=arguments,b=a.length,a=a[0],c=1;c<b;c++)a=a+", "+a;this.divObj.addClass(a);return this};b.removeClassDiv=function(){for(var a=arguments,b=a.length,a=a[0],c=1;c<b;c++)a=a+", "+a;this.divObj.removeClass(a);return this};b.addClassDivBg=function(){for(var a=arguments,b=a.length,a=a[0],c=1;c<b;c++)a=a+", "+a;this.divBgSpanObj.addClass(a);return this};b.removeClassDivBg=function(){for(var a=
arguments,b=a.length,a=a[0],c=1;c<b;c++)a=a+", "+a;this.divBgSpanObj.removeClass(a);return this};b.addClassDivText=function(){for(var a=arguments,b=a.length,a=a[0],c=1;c<b;c++)a=a+", "+a;this.divTextSpanObj.addClass(a);return this};b.removeClassDivText=function(){for(var a=arguments,b=a.length,a=a[0],c=1;c<b;c++)a=a+", "+a;this.divTextSpanObj.removeClass(a);return this};volcano.LiImageForm=c})(window);(function(c){function b(a){if(U.isKeyboardEvent){a=a.keyCode;H=V=false;var b=100,c=10,d=false;if(a==38||a==39)b=-100,c=-10,d=true;else if(a==40||a==37)b=100,c=10,d=true;d&&(T&&(t=v,A=y,T=false),w.x(w.x()+b),v+=c,s=v-t+s,t=v)}}function a(a){if(U.isMouseEvent){a=c.event||a;a=Math.max(-1,Math.min(1,a.wheelDelta||-a.detail));H=V=false;var b=100,d=10;a>0?(b=-100,d=-10):(b=100,d=10);T&&(t=v,A=y,T=false);w.x(w.x()+b);v+=d;s=v-t+s;t=v}}function f(){J=innerHeight;Z=innerWidth;M=-(Z/2);K=J/ia;x=J-K*2;x<W?(x=
W,K=(J-W)*0.5):x>X&&(x=X,K=(J-X)*0.5);C=F=E?x/(q+0.7)-o/(q/(q-1)):x/q-o/(q/(q-1));$=x;aa=u*C+o*(u-1);R.width(0).height(0).x(-M);Y.width(0).height(0).x(0).y(K);w.height(0).width(0);for(var a=0,b=0,c=0,c=0;c<I;c++)a=c%u*(C+o)+M,b=parseInt(c/(I/q))*(F+o),ga[c].width(C).height(F).x(a).y(b);if(E)for(c=P;c<m;c++)a=c%u*(C+o)+M,b=parseInt(q)*(F+o)-o+fa,ha[c-P].width(C).height(F).x(a).y(b);k.imageWidth=C;k.imageHeight=F;k.viewPortBack=M;R.setStyle("perspective-origin-y",innerHeight/2,volcano._browserPrefix)}
function d(){D.width(innerWidth).height(innerHeight);n=innerWidth-aa>0?0:innerWidth-aa;p=innerHeight-$>0?0:innerHeight-$;if(V)L==="auto"?w.move(v,y,0):L==="vertical"?(w.move(0,y,0),viewPort.move(0,y,0)):L==="horizontal"&&w.move(v,0,0),i>0.3?(i-=0.3*r,i=i<0?0:i):i<-0.3?(i+=0.3*r,i=i>0?0:i):i=0;else if(H)i>0.3?(i-=0.3*r,i=i<0?0:i):i<-0.3?(i+=0.3*r,i=i>0?0:i):i=0;else{var a=w.x(),b=w.y();if(Math.abs(s)>0||Math.abs(z)>0)s=Math.abs(s)<0.9?0:s*G,z=Math.abs(z)<0.9?0:z*G;if(U.isBounceBack){S=false;if(a>0||
a<n){var c=a>0?0:n;s===0||ba?(s=(c-a)*ja,ba=true):s*=ka;S=true}if(b>0||b<p)c=b>0?0:p,z===0||ca?(z=(c-b)*ja,ca=true):z*=ka}var d,e;if(Math.abs(s)>0.01||Math.abs(z)>0.01){if(L==="auto"){d=a>0&&a<1?0:a>n-1&&a<n?n:a+s;e=b>0&&b<1?0:b>p-1&&b<p?p:b+z;if(a>0&&a<1||a>n-1&&a<n)ba=false;if(b>0&&b<1||b>p-1&&b<p)ca=false}else if(L==="vertical"){if(d=0,e=b>0&&b<1?0:b>p-1&&b<p?p:b+z,b>0&&b<1||b>p-1&&b<p)ca=false}else if(L==="horizontal"){d=a>0&&a<1?0:a>n-1&&a<n?n:a+s;if(a>0&&a<1||a>n-1&&a<n)ba=false;e=0}w.move(d,
e,0)}if(volcano.has3d){N=s;if(N>O&&S===false)B!=="leftFast"&&(r=0.1),B="leftFast";else if(N<-O&&S===false)B!=="rightFast"&&(r=0.1),B="rightFast";else if(0<N&&N<da&&S===false)B!=="leftSlow"&&(r=0.1),B="leftSlow";else if(0>N&&N>da&&S===false)B!=="rightSlow"&&(r=0.1),B="rightSlow";else if(0===N&&N===da||S===true)B!=="stop"&&(r=0.1),B="stop";da=N;r=r+0.3>na?1:r+0.3;B==="stop"||S?i>0.3?(i-=0.3*r,i=i<0?0:i):i<-0.3?(i+=0.3*r,i=i>0?0:i):i=0:B==="leftSlow"?(i=i<-O?-O:i-0.8*r,i=i<0?0:i):B==="rightSlow"?(i=
i>O?O:i+0.8*r,i=i>0?0:i):B==="leftFast"?i=i>=O?O:i+la*r:B==="rightFast"&&(i=i<=-O?-O:i-la*r)}}volcano.has3d&&Y.rotationY(-i)}function j(a){if(U.isMouseEvent){var b=volcano.hasTouch?a.touches[0]:a;a.preventDefault();D.addEventListener(volcano.e.MOUSE_MOVE,e);D.addEventListener(volcano.e.MOUSE_UP,g);D.addEventListener(volcano.e.CANCEL,g);V=false;H=true;l=b.pageX-w.x();Q=b.pageY-w.y();T=true}}function e(a){if(U.isMouseEvent){var b=volcano.hasTouch?a.touches[0]:a;a.preventDefault();V=true;H=false;a=b.pageY;
v=b.pageX-l;y=a-Q;T&&(t=v,A=y,T=false);s=v-t;z=y-A;t=v;A=y}}function g(){H=V=false;D.removeEventListener(volcano.e.MOUSE_MOVE,e);D.removeEventListener(volcano.e.MOUSE_UP,g);D.removeEventListener(volcano.e.CANCEL,g)}var h=function(a){this.initialize(a)},k=h.prototype=new volcano.VSprite,G=0.95,n,p,l=0,Q=0,v=0,y=0,s=0,z=0,t=0,A=0,H,L="horizontal",r=0,I=68,q=2,u=I/q,o=20,E=true,P=-1,m=-1,fa=5,J,Z,ia=10,K,x,F,C,$,aa,M,ga=[],ha=[];k._imageArr=[];k._imageReflectionArr=[];k.isBounceBack=true;k.isMouseEvent=
true;k.isKeyboardEvent=true;var V=false,ka=0.7,ja=0.1,ba=false,ca=false,O=30,la=2,N=0,i=0,da=0,S=false,B="stop",na=1,r=0.1,T=false,D,w,Y,R,ma=false,ea=[],W=200,X=500,U;k.VSprite_initialize=k.initialize;k.initialize=function(a){U=this;this.VSprite_initialize();D=a};k.drawView=function(){!ma&&ea.length>0&&(ma=true,this.initContainer())};k.initContainer=function(){J=innerHeight;Z=innerWidth;this.isBounceBack=true;K=J/ia;I=ea.length;u=I/q;x=J-K*2;x<W?(x=W,K=(J-W)*0.5):x>X&&(x=X,K=(J-X)*0.5);C=F=E?x/(q+
0.7)-o/(q/(q-1)):x/q-o/(q/(q-1));$=x;aa=u*C+o*(u-1);M=-(Z/2);R=(new volcano.VSprite).id("mainContainer").width(0).height(0).x(-M);Y=(new volcano.VSprite).id("container").width(0).height(0).x(0).y(K);var c=document.createElement("ul");w=(new volcano.VSprite(c)).id("viewPort").height(0).width(0);this.addElement(R);R.addElement(Y);Y.addElement(w);for(var e=0,g=0,c=c=0;c<I;c++)e=c%u*(C+o)+M,g=parseInt(c/(I/q))*(F+o),e=(new volcano.LiImageForm(void 0,{defaultValue:"off"})).width(C).height(F).x(e).y(g).dataProvider(ea[c]),
E&&parseInt(c/(I/q))===q-1&&(P===-1&&(P=c),m=c+1),w.addElement(e),ga.push(e);this._imageArr=ga;if(E){for(c=P;c<m;c++)e=c%u*(C+o)+M,g=parseInt(q)*(F+o)-o+fa,e=(new volcano.LiImageForm(void 0,{defaultValue:"off"})).width(C).height(F).x(e).y(g),w.addElement(e),e.rotationX(180),ha.push(e);this._imageReflectionArr=ha}this.sysMgr=D;this.transViewPort=w;this.container=Y;this.mainContainer=R;this.imageWidth=C;this.imageHeight=F;this.viewPortBack=M;D.addEventListener(volcano.e.MOUSE_DOWN,j);D.addEventListener("resize",
f);D.addEnterFrameListener(d);D.setStyle("Perspective","0px",volcano._browserPrefix);R.setStyle("Perspective","800px",volcano._browserPrefix);R.setStyle("perspective-origin-y",innerHeight/2,volcano._browserPrefix);D.addEventListener("mousewheel",a,false);document.body.addEventListener("keydown",b)};k.dataProvider=function(a){ea=a};k.dataRefresh=function(){};k.setConfig=function(a){q=a.cols===void 0?q:a.cols;o=a.imageGap===void 0?o:a.imageGap;E=a.isReflection===void 0?E:a.isReflection};k.setChannelUserLink=
function(){};k.setNewMessage=function(){};c.volcano.ThreeDimensionsScroller=h})(window);
