...
(this._dataProvider=a,this.id(this._dataProvider.id),this.imageUrl(this._dataProvider.filepath),this.title(this._dataProvider.title),this.lastTalk({user:"",talk:""}),this.userCnt(this._dataProvider.userCnt),this.onair(this._dataProvider.onair),this.company(this._dataProvider.company),this.actors(this._dataProvider.actors),this.story(this._dataProvider.story),this.twitterQuery(this._dataProvider.twitterQuery),this):this._dataProvider};b._title="";b.title=function(a){return arguments.length?(this._title=
a,this):this._title};b._lastTalk={};b.lastTalk=function(a){return arguments.length?(this._lastTalk=a,this._lastTalk.user.trim()===""&&this._lastTalk.talk.trim()===""?(this.divTextSpanObj._domElement.innerHTML=this.title(),this.removeClassDivText("chat")):(this.divTextSpanObj._domElement.innerHTML="["+this._lastTalk.user+"] "+this._lastTalk.talk,this.addClassDivText("chat")),this):this._lastTalk};b._userCnt="";b.userCnt=function(a){return arguments.length?(this._userCnt=a,this.spanOnAirObj._domElement.innerHTML=
this._userCnt===""?0:parseInt(this._userCnt),this):this._userCnt};b.onair=function(a){(this._onair=a)?this.addClassOnAir("onair"):this.removeClassOnAir("onair")};b._company="";b.company=function(a){return arguments.length?(this._company=a,this):this._company};b._actors="";b.actors=function(a){return arguments.length?(this._actors=a,this):this._actors};b._story="";b.story=function(a){return arguments.length?(this._story=a,this):this._story};b._twitterQuery="";b.twitterQuery=function(a){return arguments.length?
